...
async function loadAdminTable() {
    try {
        ...
        persons.forEach(person => {
            ...
            row.innerHTML = `
                <td><img src="${person.image_url}" alt="${person.name}" style="width: 50px; height: 50px; object-fit: cover; border-radius: 5px;"></td>
                <td>${person.name}</td>
                <td>${person.age}</td>
                <td>
                ...
                <td>${getCategoryName(person.category)}</td>
                <td>
                    ${person.current_club ? `
                    <div class="d-flex align-items-center">
            ...
            <div class="card-body player-info">
                ...
                <div class="player-details">
                    <div class="nationality">
                        ...
                        <img src="${person.nationality_flag}" alt="${person.nationality}" class="flag-img" style="width: 30px; height: 20px; object-fit: contain;">
                    ...
                    <div class="detail-item">
                        ...
                        <strong>النادي الحالي:</strong>
                        <div class="d-flex align-items-center">
                            <img src="${person.current_club_logo}" alt="${person.current_club}" class="club-logo" style="width: 30px; height: 30px; object-fit: contain;">
                    ...
                    <div class="club-history">
                        ${previousClubs.map(club => `
                            <div class="club-badge">
                                <img src="${club.logo_url}" alt="${club.name}" class="club-logo" style="width: 40px; height: 40px; object-fit: contain; margin-left: 5px;">
                                <span>${club.name}</span>
                            </div>
                        `).join('')}
                    </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="player-image-details">
                        <img src="${person.image_url}" alt="${person.name}" class="img-fluid rounded player-full-image">
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="player-details-info">
                        <h4 class="mb-4">${person.name}</h4>
                        
                        <div class="details-section">
                            <div class="detail-row">
                                <div class="detail-label">الجنسية:</div>
                                <div class="detail-value">
                                    <img src="${person.nationality_flag}" alt="${person.nationality}" class="flag-img" style="width: 40px; height: 25px; object-fit: contain; margin-left: 5px;">
                                    <span>${person.nationality}</span>
                                </div>
                            </div>
                            ...
                            <div class="detail-row">
                                ...
                                <div class="detail-value">
                                    <img src="${person.current_club_logo}" alt="${person.current_club}" class="club-logo" style="width: 40px; height: 40px; object-fit: contain; margin-left: 5px;">
                                    <span>${person.current_club}</span>
                                </div>
                            </div>` : ''}
                        </div>
    ...
    return `
        <div class="card h-100">
            <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                <span>${getCategoryName(person.category)}</span>
                <img src="${person.nationality_flag}" alt="${person.nationality}" style="width: 30px; height: 20px; object-fit: contain;">
            </div>
            <div class="card-body text-center">
                <img src="${person.image_url}" alt="${person.name}" class="img-fluid rounded mb-2" style="width: 100px; height: 100px; object-fit: cover;">
                <h5 class="card-title">${person.name}</h5>
                <p class="card-text">
                    العمر: ${person.age} سنة
                    ${showCurrentClub && person.current_club ? `<br>النادي: ${person.current_club}` : ''}
                </p>
                <button class="btn btn-primary btn-sm" onclick="viewPersonDetails('${person.id}')">
                    عرض التفاصيل
                </button>
            </div>
        </div>
