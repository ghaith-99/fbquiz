                ...
                <div class="col-md-8">
                    <div class="player-details-info">
                        ...
                        <div class="details-section">
                            ...
                            ${person.height ? `
                            <div class="detail-row">
                                <div class="detail-label">الطول:</div>
                                <div class="detail-value">${person.height} سم</div>
                            </div>` : ''}
                            ...
                            <div class="detail-row">
                                ...
                                <div class="detail-value">
                                    <img src="${person.current_club_logo}" alt="${person.current_club}" class="club-logo">
                                    <span>${person.current_club}</span>
                                    ${person.club_number ? `<span class="badge bg-primary ms-2">رقم ${person.club_number}</span>` : ''}
                                </div>
                            </div>` : ''}
                            
                            ${person.national_number ? `
                            <div class="detail-row">
                                <div class="detail-label">رقم المنتخب:</div>
                                <div class="detail-value">
                                    <span class="badge bg-success">${person.national_number}</span>
                                </div>
                            </div>` : ''}
                        </div>
...
async function savePerson() {
    ...
    const formData = {
        ...
        position: document.getElementById('personPosition').value || null,
        height: document.getElementById('personHeight').value ? parseInt(document.getElementById('personHeight').value) : null,
        national_number: document.getElementById('personNationalNumber').value ? parseInt(document.getElementById('personNationalNumber').value) : null,
        club_number: document.getElementById('personClubNumber').value ? parseInt(document.getElementById('personClubNumber').value) : null
    };
...
async function editPerson(id) {
    try {
        ...
        document.getElementById('personHeight').value = person.height || '';
        document.getElementById('personNationalNumber').value = person.national_number || '';
        document.getElementById('personClubNumber').value = person.club_number || '';
